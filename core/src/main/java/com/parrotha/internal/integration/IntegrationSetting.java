...
public class IntegrationSetting implements Serializable, Cloneable {
    private String id;
    private String name;
    ...
    public IntegrationSetting(String name, String value, String type, boolean multiple) {
    ...
    public IntegrationSetting(Map map) {
