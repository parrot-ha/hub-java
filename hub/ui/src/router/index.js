...
const router = createRouter({
  ...
  routes: [
    ...
    },
    {
      path: "/iaas",
      name: "InstalledApps",
      component: () => import("../views/app/InstalledAppList.vue"),
    },
    {
      path: "/iaas/:id",
      name: "InstalledAppInfo",
      component: () => import("../views/app/InstalledAppInfo.vue"),
    },
    {
      path: "/iaas/:id/cfg",
      name: "InstalledAppConfig",
      component: () => import("../views/app/InstalledAppConfig.vue"),
    },
    {
      path: "/iaas/:id/cfg",
      name: "InstalledAppConfig",
    ...
    },
    {
      ...
      name: "InstalledAppConfigSubRoute",
      component: () => import("../views/app/InstalledAppConfig.vue"),
    },
    {
      path: "/iaa-add",
      name: "InstalledAppAdd",
      component: () => import("../views/app/InstalledAppAdd.vue"),
    },
    {
      path: "/integrations",
      name: "Integrations",
