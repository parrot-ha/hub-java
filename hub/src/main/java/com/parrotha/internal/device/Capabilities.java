...
public enum Capabilities {
    ...
    AUDIO_VOLUME("AudioVolume", new Capability("", "AudioVolume", "capability.audioVolume",
            ...
            Arrays.asList(new Command("setVolume", new CommandArgument("volume", "NUMBER")),
    ...
    LOCK_CODES("LockCodes", new Capability("", "LockCodes", "capability.lockCodes",
            Arrays.asList(new Attribute("", "ENUM", "codeChanged", Arrays.asList(new String[]{"added", "changed", "deleted", "failed"})),
                    new Attribute("", "NUMBER", "codeLength", null),
                    new Attribute("", "JSON_OBJECT", "lockCodes", null),
                    new Attribute("", "NUMBER", "maxCodes", null)),
            Arrays.asList(new Command("deleteCode", new CommandArgument("codePosition", "NUMBER")), new Command("getCodes"),
                    new Command("setCode", new CommandArgument("codePosition", "NUMBER", true), new CommandArgument("pinCode", "STRING", true),
                            new CommandArgument("name", "STRING", false)),
                    new Command("setCodeLength", new CommandArgument("pinCodeLength", "NUMBER", true))))),
    ...
    SPEECH_SYNTHESIS("SpeechSynthesis", new Capability("", "SpeechSynthesis", "capability.speechSynthesis", null,
            Arrays.asList(new Command("speak", new CommandArgument("phrase", "STRING"))))),
    ...
    SWITCH_LEVEL("SwitchLevel", new Capability("", "SwitchLevel", "capability.switchLevel",
            ...
            Arrays.asList(new Command("setLevel", new CommandArgument("level", "NUMBER", true), new CommandArgument("duration", "NUMBER", false))))),
