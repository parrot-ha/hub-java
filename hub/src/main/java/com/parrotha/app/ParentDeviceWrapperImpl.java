...
public class ParentDeviceWrapperImpl extends DeviceWrapperImpl implements ChildDeviceWrapper {
    private EntityService entityService;
    private Device device;

    public ParentDeviceWrapperImpl(Device device, DeviceService deviceService, EntityService entityService, LocationService locationService) {
