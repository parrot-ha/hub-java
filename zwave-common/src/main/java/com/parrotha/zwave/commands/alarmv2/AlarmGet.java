 ...
 */
public class AlarmGet extends com.parrotha.zwave.commands.alarmv1.AlarmGet {
    ...
    public List<Short> getPayload() {
        return Stream.of(alarmType, zwaveAlarmType).collect(Collectors.toList());
    }
